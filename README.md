...
example ~/mforensics.sh Acme-Corp
...
│   │   └── TID001-Acme-Corp2-2026-05-08:10.30.log
│   ├── markdown/
│   │   ├── TID001-Acme-Corp1-2026-05-08:09.00.md
│   │   └── TID001-Acme-Corp2-2026-05-08:10.30.md
│   ├── notes/
│   │   └── notes.md
│   └── screenshots/
│       ├── TID001-09-15-22.png
...
Rotation	New log file every 300 lines or 2 MB
...
scrot	Also triggers screenshot
...
$ ~/mforensics.sh Client-Audit
  ...
  (TID001 | log-1)$ nmap -sV 10.10.10.5
  Starting Nmap...
  [output captured]

  (TID001 | log-1)$ mfscreenshot
  📸  Select area for screenshot...
  [✓]  Screenshot saved: TID001-09-15-22.png

  (TID001 | log-1)$ mfnote "Found open SSH on port 22"
  [✓]  Note saved.

  (TID001 | log-1)$ [close terminal]
  Session ended.
Why "Mahsusa"?
